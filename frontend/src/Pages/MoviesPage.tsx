...
function MoviesPage (){
    ...
    return(
       <div>
            ...
            <div>
                <h1>Popular</h1>
                {isLoading ? <h2>Loading...</h2> : <MovieRow movies={movies.popular} />}
            </div>
            <div>
                <h1>Top Rated</h1>
                {isLoading ? <h2>Loading...</h2> : <MovieRow movies={movies.top_rated} />}
            </div>
            <div>
                <h1>Now Playing</h1>
                {isLoading ? <h2>Loading...</h2> : <MovieRow movies={movies.now_playing} />}
            </div>
            <div>
                <h1>Upcoming</h1>
                {isLoading ? <h2>Loading...</h2> : <MovieRow movies={movies.upcoming} />}
            </div>
        </div>
